/*========================================================*/
/*                                                        */
/*  pfitsio.c       version 3.5.0         2015.10.07      */
/*                                                        */
...
/*--------------------------------------------------------*/
double scale(const int size, float *data, int16_t *idata, double *fitsbzero)
{
        int     i;
        float   min,
                max;
...
/** scalling factors **/
  ...
  else
  {
    ...
    for (i=0; i<size; i++)
      idata[i]=(int16_t)rint((data[i]-FITS_bzero)/FITS_bscale);
  }
